...
std::shared_future<StoreResultType> MediaLogClient::StoreAsync(const std::string& camera_name,
...
StoreResultType MediaLogClient::Store(const std::string& camera_name, const std::string& tag,
                                      const RPCParameters& parameters) {
    return StoreAsync(camera_name, tag, parameters).get();
}

StoreResultType MediaLogClient::Store(const std::string& camera_name,
                                      const RPCParameters& parameters) {
...
std::shared_future<StoreResultType> MediaLogClient::StoreAsync(
    ...
    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::spot_cam::StoreRequest,
                                                      ::bosdyn::api::spot_cam::StoreResponse,
                                                      ::bosdyn::api::spot_cam::StoreResponse>(
        request,
        std::bind(&::bosdyn::api::spot_cam::MediaLogService::StubInterface::AsyncStore,
                  m_stub.get(), _1, _2, _3),
        std::bind(&MediaLogClient::OnStoreComplete, this, _1, _2, _3, _4, _5), std::move(response),
        parameters);

    return future;
}

StoreResultType MediaLogClient::Store(::bosdyn::api::spot_cam::StoreRequest& request,
                                      const RPCParameters& parameters) {
    return StoreAsync(request, parameters).get();
}

void MediaLogClient::OnStoreComplete(MessagePumpCallBase* call,
                                     const ::bosdyn::api::spot_cam::StoreRequest& request,
                                     ::bosdyn::api::spot_cam::StoreResponse&& response,
                                     const grpc::Status& status,
                                     std::promise<StoreResultType> promise) {
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::spot_cam::StoreResponse>(
...
GetStatusResultType MediaLogClient::GetStatus(const std::string& logpoint_name,
                                              const RPCParameters& parameters) {
    return GetStatusAsync(logpoint_name, parameters).get();
}

std::shared_future<GetStatusResultType> MediaLogClient::GetStatusAsync(
    ::bosdyn::api::spot_cam::GetStatusRequest& request, const RPCParameters& parameters) {
    std::promise<GetStatusResultType> response;
    std::shared_future<GetStatusResultType> future = response.get_future();
    BOSDYN_ASSERT_PRECONDITION(m_stub != nullptr, "Stub for service is unset!");

    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::spot_cam::GetStatusRequest,
                                                      ::bosdyn::api::spot_cam::GetStatusResponse,
                                                      ::bosdyn::api::spot_cam::GetStatusResponse>(
        request,
        std::bind(&::bosdyn::api::spot_cam::MediaLogService::StubInterface::AsyncGetStatus,
                  m_stub.get(), _1, _2, _3),
...
GetStatusResultType MediaLogClient::GetStatus(::bosdyn::api::spot_cam::GetStatusRequest& request,
                                              const RPCParameters& parameters) {
    return GetStatusAsync(request, parameters).get();
}

void MediaLogClient::OnGetStatusComplete(MessagePumpCallBase* call,
                                         const ::bosdyn::api::spot_cam::GetStatusRequest& request,
                                         ::bosdyn::api::spot_cam::GetStatusResponse&& response,
                                         const grpc::Status& status,
                                         std::promise<GetStatusResultType> promise) {
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::spot_cam::GetStatusResponse>(
            status, response, SDKErrorCode::Success);

    promise.set_value({ret_status, std::move(response)});
}

std::shared_future<TagResultType> MediaLogClient::TagAsync(const std::string& logpoint_name,
                                                           const std::string& tag,
                                                           const RPCParameters& parameters) {
...
TagResultType MediaLogClient::Tag(const std::string& logpoint_name, const std::string& tag,
                                  const RPCParameters& parameters) {
...
std::shared_future<TagResultType> MediaLogClient::TagAsync(
    ...
    MessagePumpCallBase* one_time =
        InitiateAsyncCall<::bosdyn::api::spot_cam::TagRequest, ::bosdyn::api::spot_cam::TagResponse,
            ...
            request,
            std::bind(&::bosdyn::api::spot_cam::MediaLogService::StubInterface::AsyncTag,
                      m_stub.get(), _1, _2, _3),
...
TagResultType MediaLogClient::Tag(::bosdyn::api::spot_cam::TagRequest& request,
                                  const RPCParameters& parameters) {
    return TagAsync(request, parameters).get();
}

void MediaLogClient::OnTagComplete(MessagePumpCallBase* call,
                                   const ::bosdyn::api::spot_cam::TagRequest& request,
                                   ::bosdyn::api::spot_cam::TagResponse&& response,
                                   const grpc::Status& status,
                                   std::promise<TagResultType> promise) {
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::spot_cam::TagResponse>(
            status, response, SDKErrorCode::Success);
...
std::shared_future<DebugResultType> MediaLogClient::EnableDebugAsync(
    ...
    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::spot_cam::DebugRequest,
                                                      ::bosdyn::api::spot_cam::DebugResponse,
                                                      ::bosdyn::api::spot_cam::DebugResponse>(
        request,
        std::bind(&::bosdyn::api::spot_cam::MediaLogService::StubInterface::AsyncEnableDebug,
                  m_stub.get(), _1, _2, _3),
...
DebugResultType MediaLogClient::EnableDebug(::bosdyn::api::spot_cam::DebugRequest& request,
                                            const RPCParameters& parameters) {
    return EnableDebugAsync(request, parameters).get();
}

void MediaLogClient::OnEnableDebugComplete(MessagePumpCallBase* call,
                                           const ::bosdyn::api::spot_cam::DebugRequest& request,
                                           ::bosdyn::api::spot_cam::DebugResponse&& response,
                                           const grpc::Status& status,
                                           std::promise<DebugResultType> promise) {
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::spot_cam::DebugResponse>(
            status, response, SDKErrorCode::Success);
...
std::shared_future<ListCamerasResultType> MediaLogClient::ListCamerasAsync(
    ...
    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::spot_cam::ListCamerasRequest,
                                                      ::bosdyn::api::spot_cam::ListCamerasResponse,
                                                      ::bosdyn::api::spot_cam::ListCamerasResponse>(
        request,
        std::bind(&::bosdyn::api::spot_cam::MediaLogService::StubInterface::AsyncListCameras,
                  m_stub.get(), _1, _2, _3),
...
ListCamerasResultType MediaLogClient::ListCameras(const RPCParameters& parameters) {
...
void MediaLogClient::OnListCamerasComplete(
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::spot_cam::ListCamerasResponse>(
            status, response, SDKErrorCode::Success);

    promise.set_value({ret_status, std::move(response)});
}

std::shared_future<DeleteResultType> MediaLogClient::DeleteAsync(const std::string& logpoint_name,
                                                                 const RPCParameters& parameters) {
...
DeleteResultType MediaLogClient::Delete(const std::string& logpoint_name,
                                        const RPCParameters& parameters) {
...
std::shared_future<DeleteResultType> MediaLogClient::DeleteAsync(
    ...
    MessagePumpCallBase* one_time = InitiateAsyncCall<::bosdyn::api::spot_cam::DeleteRequest,
                                                      ::bosdyn::api::spot_cam::DeleteResponse,
                                                      ::bosdyn::api::spot_cam::DeleteResponse>(
        request,
        std::bind(&::bosdyn::api::spot_cam::MediaLogService::StubInterface::AsyncDelete,
                  m_stub.get(), _1, _2, _3),
        std::bind(&MediaLogClient::OnDeleteComplete, this, _1, _2, _3, _4, _5), std::move(response),
        parameters);

    return future;
}

DeleteResultType MediaLogClient::Delete(::bosdyn::api::spot_cam::DeleteRequest& request,
                                        const RPCParameters& parameters) {
    return DeleteAsync(request, parameters).get();
}

void MediaLogClient::OnDeleteComplete(MessagePumpCallBase* call,
    ...
    ::bosdyn::common::Status ret_status =
        ProcessResponseAndGetFinalStatus<::bosdyn::api::spot_cam::DeleteResponse>(
            status, response, SDKErrorCode::Success);
